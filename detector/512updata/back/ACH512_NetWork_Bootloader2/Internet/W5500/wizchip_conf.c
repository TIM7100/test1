...
{
    // 注意：必须按照结构体声明顺序初始化
    _WIZCHIP_IO_MODE_,           // if_mode
    {'W', '5', '5', '0', '0', '\0'},  // id[6]
    {                               // CRIS
        wizchip_cris_enter,         // _enter
        wizchip_cris_exit           // _exit
    },
    {                               // CS
        wizchip_cs_select,          // _select
        wizchip_cs_deselect         // _deselect
    },
    {                               // IF 联合体
        {                           // BUS
            wizchip_bus_readbyte,   // _read_byte
            wizchip_bus_writebyte   // _write_byte
        }
    }
};
