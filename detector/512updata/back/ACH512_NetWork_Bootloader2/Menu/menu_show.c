...
void ShadowCountShow(u8 Result)
{
    ...
    else
    {
        ...
        LCD_UartSend("DC24(148,184,'- \"Cancel\"返回 -',4);\r\n");
    }
}
...
void RunningShow(u8 Action)          //加载、下载页面显示
{
    ...
    if (DeviceLanguageFlag == EN)
    {
        ...
        {
            LCD_UartSend("DC24(166,98,'Downloading...',5);\r\n");
        }
        else if (Action == UPDATE_RUNNING)
        {
            LCD_UartSend("DC24(166,98,'Updating...',5);\r\n");
        }
        else if (Action == JUMP_APP_RUNNING)
        {
            LCD_UartSend("DC24(166,98,'Watiting...',5);\r\n");
        }
    }
    else
    {
        if (Action == DOWNLOAD_RUNNING)
        {
            LCD_UartSend("DC24(166,98,'下载中...',5);\r\n");
        }
        else if (Action == UPDATE_RUNNING)
        {
            LCD_UartSend("DC24(166,98,'校验中...',5);\r\n");
        }
        else if (Action == JUMP_APP_RUNNING)
        {
            LCD_UartSend("DC24(166,98,'等待...',5);\r\n");
        }
    }
