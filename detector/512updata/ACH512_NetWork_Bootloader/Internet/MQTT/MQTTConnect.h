...
DLLExport int MQTTSerialize_connect(unsigned char* buf, int buflen, MQTT_CONNECT_PACKET* options);
DLLExport int MQTTDeserialize_connect(MQTT_CONNECT_PACKET* data, unsigned char* buf, int len);
