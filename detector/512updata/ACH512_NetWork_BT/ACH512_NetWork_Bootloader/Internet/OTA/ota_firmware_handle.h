...
//各种标志位地址
#define FLASHSWITCHAddr   (DATA_AREA_ADDR + 0x10)
#define Buzzer_ADDR       (DATA_AREA_ADDR + 0x20)
#define light_ADDR        (DATA_AREA_ADDR + 0x30)
#define LEVEL_cnt_ADDR    (DATA_AREA_ADDR + 0x80)
#define Beep_ADDR         (DATA_AREA_ADDR + 0xA0)

// #define WIFI_AUTH_BASE      (0x2FE00) 
#define WIFI_ACCOUNT_ADDR   (DATA_AREA_ADDR + 0x40)   
#define WIFI_PASSWORD_ADDR  (DATA_AREA_ADDR + 0x60)

//APP返回标志位
#define APPTOIAP_ADDR                (0x7F600)
