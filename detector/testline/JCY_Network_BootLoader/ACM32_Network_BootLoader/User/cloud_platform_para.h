 ...
 *                            云平台设备的密钥和名字修改区（修改重点）                         *
************************************************************************************************/
#define PRODUCT_ID     "FPMN6FY8R7"							//产品ID
#define DEVICE_NAME    "JCY_048"						    //设备名												
#define DEVICE_SECRET  "KBGBVnfuxTHfZOnRTGYB+w=="			//设备密钥，需要通过解密后，才能转换成 密码
#define DEVICE_VERSION "V2_1"								//设备版本，更改了代码时，需要发生变化，只修改设备名和密钥时，不需要变化
