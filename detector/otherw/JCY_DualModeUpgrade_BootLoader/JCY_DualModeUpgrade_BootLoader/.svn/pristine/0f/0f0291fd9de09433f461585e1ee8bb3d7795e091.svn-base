...
void ConnectShow(u8 ShowLanguage)          //连接页面显示
{
    ...
    if (ShowLanguage == Chinese)
    {
        LCD_UartSend("DC16(40,55,'网络连接中',5);\r\n");
    }
    else if (ShowLanguage == English)
    {
