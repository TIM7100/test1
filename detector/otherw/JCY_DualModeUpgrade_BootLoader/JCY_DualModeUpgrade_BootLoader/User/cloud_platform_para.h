 ...
 *                               云平台域名和端口的更改位置                                      *
************************************************************************************************/
#define SERVER_NAME    "2L33541L3O.iotcloud.tencentdevices.com"       //"iotcloud-mqtt.gz.tencentdevices.com"          
#define SERVERPORT     8883                           		          //1883   // 配置远程服务器端口


/***********************************************************************************************
 *                            云平台设备的密钥和名字修改区（修改重点）                         *
************************************************************************************************/
#define PRODUCT_ID     "2L33541L3O"							//产品ID
#define DEVICE_NAME    "JCY_TEST1"						    //设备名												
#define DEVICE_SECRET  "oDgAW8ivAShgfsRQedzwrA=="			//设备密钥，需要通过解密后，才能转换成 密码
#define DEVICE_VERSION "V2_0"								//设备版本，更改了代码时，需要发生变化，只修改设备名和密钥时，不需要变化
...
//#define SHADOW_PUB_TOPIC                  "$shadow/operation/%s/%s"             //影子设备
...
#define PRODUCTKEY_LEN              15                     //产品密钥长度 ProductKey     字符串长度        
#define DEVICENAME_LEN              20                     //设备名字长度 DeviceName     字符串长度        
#define DEVICESECRET_LEN            25                     //设备密钥长度 DeviceSecret   字符串长度   
