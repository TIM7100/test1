...
#ifdef STD_SYSTICK_ENABLED  // To activate macro in ACM32Fxx_HAL.h      
    System_SysTick_Init();
#endif
}
...
{ 
  /* User can add his own implementation to report the file name and line number, */
    ...
    printfS("Wrong parameters value: file %s on line %d\r\n", file, line) ;
